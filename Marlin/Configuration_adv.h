...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_ACC        0.0125 // Stop iterating early if the accuracy is better than this
...
#define INPUT_SHAPING
  ...
  #define SHAPING_FREQ_X    27.17  // (Hz) The dominant resonant frequency of the X axis. Comment to disable shaping for X.
  #define SHAPING_FREQ_Y    30.61  // (Hz) The dominant resonant frequency of the Y axis. Comment to disable shaping for Y.
