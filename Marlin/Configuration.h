...
#define STRING_CONFIG_H_AUTHOR "(Dustin, UBL 2.1.x)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bugfix 10.8.22"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "666"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 406.86275 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 30 } // (mm) Left, Front, Right, Back insets
